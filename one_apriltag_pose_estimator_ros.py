...
class AprilTagPoseEstimator:
    def __init__(self, camera_matrix, dist_coeffs, tag_size, target_id):
        ...
        # self.image_sub = rospy.Subscriber('/global_camera/image/compressed', CompressedImage, self.image_callback)
        # For Experiments at PolyUPool, the global camera topic is different
